...
class Contact(Base):
    ...
    client_id: Mapped[str] = mapped_column(
        String, ForeignKey("clients.client_id"), nullable=False
    )
    ...
    is_primary_phone: Mapped[bool] = mapped_column(
...
class LoanPayment(Base):
    ...
    loan_id: Mapped[str] = mapped_column(
        String, ForeignKey("loans.loan_id"), nullable=False
    )
    amount: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False)
...
class RiskProfile(Base):
    ...
    client_id: Mapped[str] = mapped_column(
        String, ForeignKey("clients.client_id"), nullable=False, unique=True
    )
